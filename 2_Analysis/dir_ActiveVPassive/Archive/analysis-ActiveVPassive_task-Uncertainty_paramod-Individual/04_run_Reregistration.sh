...
SCRIPTS=${PROJECT}/scripts/2_Analysis/dir_ActiveVPassive/analysis-ActiveVPassive_task-Uncertainty_paramod-Individual
...
for SUBJ in ${SUBJECTS}; do
    ...
    for RUN in 1 2; do
        ...
        FEATPATH=${DERIV}/sub-${SUBJ}/func/analysis-ActiveVPassive_task-Run${RUN}_paramod-Individual_lvl-1.feat
