...
SCRIPTS=${PROJECT}/scripts/2_Analysis/dir_ActiveVPassive/analysis-ActiveVPassive_task-Uncertainty_paramod-None
...
for SUBJ in ${SUBJECTS}; do
    ...
    for RUN in 1 2; do
        ...
        FEATPATH=${DERIV}/sub-${SUBJ}/func/analysis-ActiveVPassive_task-Run${RUN}_paramod-None_lvl-1.feat
