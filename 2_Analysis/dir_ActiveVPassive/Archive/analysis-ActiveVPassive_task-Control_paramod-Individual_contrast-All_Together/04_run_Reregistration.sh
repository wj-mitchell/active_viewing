...
SCRIPTS=${PROJECT}/scripts/2_Analysis/dir_ActiveVPassive/analysis-ActiveVPassive_task-Control_paramod-Individual_contrast-All_Together
...
for SUBJ in ${SUBJECTS}; do
    ...
    FEATPATH=${DERIV}/sub-${SUBJ}/func/analysis-ActiveVPassive_task-Control_paramod-Individual_lvl-1_contrast-All_Together.feat
