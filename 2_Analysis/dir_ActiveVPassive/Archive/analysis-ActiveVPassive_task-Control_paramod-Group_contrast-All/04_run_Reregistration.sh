...
SCRIPTS=${PROJECT}/scripts/2_Analysis/dir_ActiveVPassive/analysis-ActiveVPassive_task-Control_paramod-Group_contrast-All
...
for SUBJ in ${SUBJECTS}; do
    ...
    FEATPATH=${DERIV}/sub-${SUBJ}/func/analysis-ActiveVPassive_task-Control_paramod-Group_lvl-1_contrast-All.feat
